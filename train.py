...
class Train:
    ...
    def __init__(self,root):
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open(r"D:\Downloads\Attendance_Management_System_Using_Face_Recognition-main\Attendance_Management_System_Using_Face_Recognition-main\Images_GUI\t_btn1.png")
    ...
    def train_classifier(self):
        ...
        for image in path:
            ...
            cv2.imshow("Loading Data",imageNp)
            cv2.waitKey(1)==13
